# i18n Documentation for inTXTonic

## Overview
The i18n system in inTXTonic supports multilingual features, allowing the application to adapt to different languages. This document focuses on the admin i18n page and its translation tools, which were recently enhanced for better usability and debugging.
